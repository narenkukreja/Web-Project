...
mysql_connect("localhost", "kukrejan_root", "root123") or die ("could not connect t the server");
...
<div class="content">
    <form action="adminModify.php" method="post">
        ...
        *Citizenship Status: <?php echo "$citizen_status<br><br>";
        ...
        Capstone:
        <input type="radio" name="capstone" value="Internship" <?php if($project_internship == "Internship")echo " checked";?>  /> Internship
        <input type="radio" name="capstone" value="Project" <?php if($project_internship == "Project")echo " checked";?> /> Project
