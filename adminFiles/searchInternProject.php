...
<div class="content">
    ...
    <table align="center" border="1">
        <tr><th colspan="3">Showing All Students</th></tr>
        <tr>
            <th>Student ID</th>
            <th>First Name</th>
            <th>Last Name</th>
        ...
        if(isset($_POST['internproj']) == "internship" ) {
            $internship = $_POST['internproj'];
            $sql = mysql_query("SELECT * FROM student_personal_info WHERE project_internship = '$internship'");
            ...
            $project = $_POST['internproj'];
            $sql = mysql_query("SELECT * FROM student_personal_info WHERE project_internship = '$project'");
