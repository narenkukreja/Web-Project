...
if(!empty($password)) {
    $result = ("UPDATE student_login SET pass ='$password' WHERE id = '$id'") or die(mysql_error());
    if(mysqli_query($link, $result)){
        echo "Profile updated successfully.<br><br>";
        echo "<a href='../index.php'>Click Here</a> to login again to view your updated file.<br>";
    }
}
